...
public class KassapaateTest {
    ...
    @Test
    public void korttiLadataanJosLukuPositiivinen(){
        kassa.lataa(kortti, 40);
        verify(kortti, times(1)).lataa(40);
    }@Test
    public void korttiaEiLadataJosLukuNegatiivinen(){
        kassa.lataa(kortti, -40);
        verify(kortti, times(0)).lataa(-40);
    }
}
